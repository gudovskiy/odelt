## ⚡️ $\textrm{ODE}_t (\textrm{ODE}_l)$: Shortcutting the Time and Length in Diffusion and Flow Models for Faster Sampling. [ArXiv preprint](https://arxiv.org/abs/2506.21714)
